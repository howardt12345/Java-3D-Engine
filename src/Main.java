...
public class Main extends JPanel {
	...
	public static void main (String[] args) {
		...
		scene.add(new Model (new Transform (new Vec4 (5, 2, 10),
				new Rotation (0, 0, 0), new Scale (2)), "house.txt", true));
		
		scene.add(new Light (new Transform (0, 5, 0)));
		/*scene.add(new Light (new Transform (5, 5, 0)));
		scene.add(new Light (new Transform (-5, 5, 0)));
		scene.add(new Light (new Transform (0, 5, 5)));
		scene.add(new Light (new Transform (0, 5, -5)));
